...
public abstract class AuthServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        ClientCredentialsTokenGranter clientCredentialsTokenGranter = new ClientCredentialsTokenGranter(defaultTokenServices, endpoints.getClientDetailsService(),
                endpoints.getOAuth2RequestFactory());
        clientCredentialsTokenGranter.setAllowRefresh(true);
        endpoints.tokenGranter(clientCredentialsTokenGranter);
    }
